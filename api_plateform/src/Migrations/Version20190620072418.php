 ...
 */
final class Version20190620072418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE album (id INT AUTO_INCREMENT NOT NULL, artists_id INT DEFAULT NULL, types_id INT NOT NULL, name VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, published_at DATETIME NOT NULL, price DOUBLE PRECISION NOT NULL, INDEX IDX_39986E4354A05007 (artists_id), INDEX IDX_39986E438EB23357 (types_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
